...
class Book(models.Model):
    author = models.CharField(max_length=100)  # Поле для имени автора, максимальная длина - 100 символов
    title = models.CharField(max_length=100,
                             db_index=True)  # Поле для названия книги, это поле индексируется для ускорения поиска
    genre = models.CharField(max_length=100)  # Поле для жанра книги
    description = models.TextField()  # Поле для описания книги, без ограничения по количеству символов
    publish = models.CharField(max_length=100)  # Поле для названия издательства
    year = models.IntegerField()  # Поле для года публикации книги
    pages = models.IntegerField()  # Поле для количества страниц в книге
    cost = models.IntegerField()  # Поле для стоимости книги
